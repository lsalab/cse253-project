...
system('sudo ip addr add 10.0.0.5/24 dev veth0')
net.pingAll()
net.terms += makeTerm(hsrc, cmd='python3 -m nefics.iec104devicelauncher -c ./var/Source.json')
net.terms += makeTerm(htx, cmd='python3 -m nefics.iec104devicelauncher -c ./var/Transmission.json')
net.terms += makeTerm(hload, cmd='python3 -m nefics.iec104devicelauncher -c ./var/Load.json')
CLI(net)
